//
//  FARCommentViewController.swift
//  House_Rating
//
...
class FARCommentViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        databaseRef.child("FAR Comment").queryOrderedByKey().observe(.childAdded, with: {
            snapshot in
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "commentCell", for: indexPath) as! FARCommentTableViewCell
    ...
    @IBAction func submit(_ sender: AnyObject) {
        ...
        if (comment?.isEmpty)! {
            ...
            // Add to database
            let databaseRef = FIRDatabase.database().reference()
            databaseRef.child("FAR Comment").childByAutoId().setValue(comment)
