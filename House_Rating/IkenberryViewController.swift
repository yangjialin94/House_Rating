...
class IkenberryViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        databaseRef.child("Ikenberry").queryOrderedByKey().observe(.childAdded, with: { snapshot in
            ...
            self.dormImage.image = UIImage(named: "Ikenberry.jpg")
