...
class AllenHallViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        databaseRef.child("Allen Hall").queryOrderedByKey().observe(.childAdded, with: { snapshot in
            ...
            self.dormImage.image = UIImage(named: "Allen Hall.jpg")
            self.dinningScore.text = "Dinning Hall: " + String(format: "%.2f", dScore) + " / 5.0"
