//
//  LARCommentViewController.swift
//  House_Rating
//
...
class LARCommentViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        databaseRef.child("LAR Comment").queryOrderedByKey().observe(.childAdded, with: {
            snapshot in
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "commentCell", for: indexPath) as! LARCommentTableViewCell
    ...
    @IBAction func submit(_ sender: AnyObject) {
        ...
        if (comment?.isEmpty)! {
            ...
            // Add to database
            let databaseRef = FIRDatabase.database().reference()
            databaseRef.child("LAR Comment").childByAutoId().setValue(comment)
