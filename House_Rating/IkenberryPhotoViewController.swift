//
//  IkenberryPhotoViewController.swift
//  House_Rating
//
...
class IkenberryPhotoViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate,UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        databaseRef.child("Ikenberry Images").queryOrderedByKey().observe(.childAdded, with: {
            snapshot in
            
            let name = snapshot.value as! String
            let imageRef = storageRef.child("Ikenberry Images").child(name)
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "photoCell", for: indexPath) as! IkenberryPhotoTableViewCell
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        let storageRef = FIRStorage.storage().reference().child("Ikenberry Images")
        ...
        let databaseRef = FIRDatabase.database().reference()
        databaseRef.child("Ikenberry Images").childByAutoId().setValue("\(imageName).png")
    }
